...
<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/elementos.css" type="text/css" >
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/footer.css" type="text/css" >
<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/buttons.css" type="text/css" >
