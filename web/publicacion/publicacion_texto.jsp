<%-- 
    Document   : publicacion_texto
    Created on : 22/05/2013, 08:21:47 PM
    Author     : Personal
--%>
                ...
                <div id="contendor-interno"> 
                    ...
                    <div id="elemento-publicacion-musica">
                        ...
                        <%-- Inicio Elemento  --%>
                            ...
                            <html:textarea name="EventoForm" property="informacion" cols="44" rows="5" value="${publicacion.getTexto()}"/><br>
                            
                             <a href="../aceptar_publicacion.do?idPublicacion=${publicacion.getIdPublicacion()}&tipoPublicacion=texto">
